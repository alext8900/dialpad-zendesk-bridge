...
> The full, authoritative operating rules for this repo. `CLAUDE.md` covers the
> project specifics and points here for these. Follow these exactly.
...
```
python -m pytest -q     # via the project venv (see README)
```
